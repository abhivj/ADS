...
combined <- cbind(fileNames,output)
combinedWithHidden <- cbind(fileNames,layer)
#write csv file with actual number of attributes
write.csv(combined,'D:\\Experiment\\exp4\\AttributeFile-AfterAutoEncoder-Full-Dimension.csv',row.names=FALSE)

#write csv file with reduced attributes
write.csv(combinedWithHidden,'D:\\Experiment\\exp4\\AttributeFile-AfterAutoEncoder-100-Dimension.csv',row.names=FALSE)
